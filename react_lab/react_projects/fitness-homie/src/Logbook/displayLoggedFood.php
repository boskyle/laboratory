...
if (!$conn-> connect_error) {
    ...
    if (!$stmt = $conn->prepare("SELECT foodname,food_log_date_simple,food_log_date,calories,carbohydrates,protein,fat FROM UserFoodsLog WHERE username = ? AND food_log_date_simple = ? ORDER by food_log_date DESC")) {
