...
function Register () {
    ...
    var urlLocalServer = 'http://fitnesshomie.boskyleprojects.com/php-endpoints/Register/register.php';
...
const emailIsValid = async (emailInput) => {
    ...
    var emailsUrl="http://fitnesshomie.boskyleprojects.com/php-endpoints/Register/check-email-exist.php";
    var matcher='';
    try {
